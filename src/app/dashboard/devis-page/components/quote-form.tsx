...
import { Plus, Trash2, Loader2, FileText, User, Calendar, CreditCard, List, MessageSquare } from "lucide-react";
...
export function QuoteForm({ onSuccess }: QuoteFormProps) {
  ...
  const { form, isLoading, onSubmit } = useQuoteForm({
    onSuccess: () => onSuccess?.(),
  });
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Détaillez les produits ou services proposés</CardDescription>
                </div>
              </div>
              <Button
                type="button"
